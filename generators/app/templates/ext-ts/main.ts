...
/**
 * MainExtension is the interface to Lens' main process
 * 
 * MainExtension api allows you to access, configure, and customize Lens data add
 * custom application menu items, and generally run custom code in Lens'
 * main process.
 *
 * MainExtension which extends Main.LensExtension runs in Lens' 'main' process (NOT 'renderer' process)
...
export default class MainExtension extends Main.LensExtension {
  ...
  /**
   * appMenus is the UI feature customizable in the main extension API.
